    ...
    return (
        <div className="card w-full bg-base-100 shadow-xl p-12">
            <div className='text-center'>
                ...
                <button className="btn uppercase text-white bg-gradient-to-r from-primary to-secondary" onClick={() => setTreatment(appointment) || document.getElementById('BookingModal').showModal()}>Book Appointment</button>
